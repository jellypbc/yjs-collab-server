 ...
 */
const group = async (description, f) => {
...
const measureTime = async (message, f) => {
  ...
  logging.print(logging.PURPLE, message, logging.GREY, ` ${time.humanizeDuration(duration / iterations)}${iterationsInfo}`);
};
